...
public class HangMan {
    ...
    private static String[] words = { "ant", "baboon", "badger", "bat", "bear", "beaver", "camel", "cat", "clam",
    ...
    private static String[] gallows = {
            ...
            " +---+\n" + " |   |\n" + " O   |\n" + "/|\\  |\n" + // if you were wondering, the only way to print '\' is
                                                                 // with a trailing escape character, which also happens
                                                                 // to be '\'
                    "     |\n" + "     |\n" + " =========\n",
    ...
    public static void main(String[] args) {
        ...
        char[] placeholders = initilizePlaceHolder(word);
    ...
    private static char[] initilizePlaceHolder(String word) {
